...
fun UroborosTheme(
    ...
    val resolvedThemeMode = themeMode ?: LocalThemeMode.current
    val resolvedDarkTheme = darkTheme ?: when (resolvedThemeMode) {
    ...
    CompositionLocalProvider(LocalThemeMode provides resolvedThemeMode) {
        MaterialTheme(
